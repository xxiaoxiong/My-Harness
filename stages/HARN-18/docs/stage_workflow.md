...
| `stages/HARN-09/` | `dc1b7da` | HARN-09 完成状态 |
| `stages/HARN-10/` | `04944af` | HARN-10 完成状态 |
| `stages/HARN-11/` | `d4909a9` | HARN-11 完成状态 |
| `stages/HARN-12/` | `8339aef` | HARN-12 完成状态 |
...
| `stages/HARN-17/` | `6570c8f` | HARN-17 完成状态 |
